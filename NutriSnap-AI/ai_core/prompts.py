...
4. Include micronutrients (Fiber, Sodium, Vitamin D, Iron, Potassium) if possible.
5. Return ONLY a valid JSON object in the following format, no markdown formatting:
{
